...
int main()
{
    ...
    t.addTest(Test::EXPECT_EQ(collide(s1,M_PI,M_PI_2,s2,0,M_PI_2),true));
    t.addTest(Test::EXPECT_EQ(collide(s1,0,M_PI_2,s2,M_PI,M_PI_2),false));
    ...
    t.addTest(Test::EXPECT_EQ(collide(s13,0,M_PI_2,s23,0,M_PI_2),true));   
    t.addTest(Test::EXPECT_EQ(collide(s13,0,M_PI_2,s23,0,M_PI),true));  
    t.addTest(Test::EXPECT_EQ(collide(s13,M_PI_2,M_PI_4,s23,0,M_PI),false));  
    ...
    t.addTest(Test::EXPECT_EQ(collide(s3,M_PI,M_PI_2,s4,5*M_PI_4,M_PI_2),false));
