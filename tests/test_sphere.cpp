...
int main()
{
    ...
    Sphere s = Sphere(Geometric::point0(), Geometric::vector(0,0,1), Geometric::point(1,0,0));
    ...
    Sphere s1 = Sphere(Geometric::point0(), Geometric::vector(0,0,1), Geometric::point(1,0,0));
    Sphere s2 = Sphere(Geometric::point(5,0,0), Geometric::vector(0,0,1), Geometric::point(6,0,0));
    ...
    Sphere s13 = Sphere(Geometric::point(1,0,0),Geometric::vector(sqrt(2)/2,sqrt(2)/2,0),Geometric::point(1/sqrt(2)+1,-1/sqrt(2),0));
    Sphere s23 = Sphere(Geometric::point(6,5,0),Geometric::vector(sqrt(2),sqrt(2),0),Geometric::point(sqrt(2)+6,-sqrt(2)+5,0));
    ...
    Sphere s3 = Sphere(Geometric::point(-10,5,-1), Geometric::vector(-1,0,0), Geometric::point(-10-1/sqrt(2),5,-1-1/sqrt(2)));
    Sphere s4 = Sphere(Geometric::point(0,4,2),Geometric::vector(0,2,0), Geometric::point(-2/sqrt(3),4+2/sqrt(3),2+2/sqrt(3)));
