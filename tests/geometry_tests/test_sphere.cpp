...
int main()
{
    ...
    t.addTest("2", Test::EXPECT_EQ(res,IntersectionObject(1,Vector(-1,0,0),Point(-1,0,0),property)));
    ...
    t.addTest("4", Test::EXPECT_EQ(res,IntersectionObject(sqrt(38),Vector(1,0,0),Point(4,3,5),property)));
    ...
    t.addTest("7", Test::EXPECT_EQ(res,IntersectionObject(sqrt(34),Vector(0,0,-1),Point(2,3,3),property)));
