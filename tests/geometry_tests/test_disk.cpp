...
int main()
{
    ...
    t.addTest("6", Test::EXPECT_EQ(i1.get_point(), Point(1,1,0)));
    ...
    t.addTest("10", Test::EXPECT_EQ(i1.get_point(), Point(1,1,0)));
    ...
    t.addTest("14", Test::EXPECT_EQ(i1.get_point(), Point(0,1,0)));
