...
int main()
{
    ...
    t.addTest("4", Test::EXPECT_EQ(res,Intersection(sqrt(41),Vector(0,0,-1),Point(2,3,4),property)));
    ...
    t.addTest("7", Test::EXPECT_EQ(res,Intersection(sqrt(35),Vector(1,0,0),Point(5,3,5),property)));
