...
SpectralColor Render::compute_ray_intersection_color(const Ray& r, const size_t n_rec) const
{
...
SpectralColor Render::calculate_punctual_light_contribution(const IntersectionObject& intersection) const
{
