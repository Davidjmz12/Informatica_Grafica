...
Color Camera::compute_random_pixel_color(int x, int y, std::vector<Geometry*> objects, std::vector<Light> lights) const
{
...
Color Camera::compute_pixel_color(int x, int y, std::vector<Geometry*> objects,  std::vector<Light> lights) const
{
    ...
    Color sum = this->compute_random_pixel_color(x, y, objects, lights);
...
std::vector<Color> Camera::paint_one_row(std::vector<Geometry*> objects,  std::vector<Light> lights,  size_t row) const
{
