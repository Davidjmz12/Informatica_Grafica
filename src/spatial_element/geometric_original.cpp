/**
 * @file spatialElement.cpp
 * @brief Implementation of the spatialElement class.
 * @authors DavidJimenez DavidTizne
 * @date 5/10/2024
 * @see spatial_element.hpp for more information.
 * 
 * This file contains the implementation of the spatialElement
 * class, which represents a point or a vector.
*/
